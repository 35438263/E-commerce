...
.paymentWrap .paymentBtnGroup .paymentMethod .method.amex {
    background-image: url("[003566].jpg");
}
                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="{{URL::to('/')}}"><i class="fa fa-phone"></i> +2 95 01 88 821</a></li>
                            <li><a href="{{URL::to('/')}}"><i class="fa fa-envelope"></i> info@domain.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="social-icons pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="{{URL::to('/')}}"><i class="fa fa-dribbble"></i></a></li>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="{{URL::to('/')}}"><img src="front/images/home/logo.png" alt="" /></a>
                    </div>
    ...
    <div class="header-bottom"><!--header-bottom-->
        <div class="container">
            <div class="row">
                        ...
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    <li><a href="{{URL::to('show-products')}}">Products</a></li>
                ...
                <div class="col-sm-3">
                    <form action="{{URL::to('search-by-name')}}" method="post">
                        {{csrf_field()}}
                    ...
                    <div class="brands_products"><!--brands_products-->
                        <h2>Brands</h2>
                            ...
                            <div class="brands-name">
                                ...
                                <li><a href="{{URL::to('/product-by-brand/'.$brand->manufacture_id)}}"> {{$brand->manufacture_name}}</a></li>
                                    </ul>
                                    @endif
                                @endforeach
                            </div>
